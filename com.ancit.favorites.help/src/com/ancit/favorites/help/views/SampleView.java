 ...
 *
 * SW-COMPONENT:    com.ancit.favorites.help
 *
 * DESCRIPTION:     -
 *
 ...
 */
package com.ancit.favorites.help.views;
...
public class SampleView extends ViewPart {
	 ...
	 */
	public static final String ID = "com.ancit.favorites.help.views.SampleView";
	...
	public void createPartControl(Composite parent) {
		...
		workbench.getHelpSystem().setHelp(viewer.getControl(), "com.ancit.favorites.help.viewer");
	...
	private void hookContextMenu() {
		...
		menuMgr.addMenuListener(manager -> SampleView.this.fillContextMenu(manager));
