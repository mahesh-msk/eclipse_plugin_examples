 ...
 * @generated
 */
public class SchoolModelSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case SchoolModelPackage.SCHOOL: {
				School school = (School)theEObject;
				T result = caseSchool(school);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SchoolModelPackage.CLASS: {
				SchoolModel.Class class_ = (SchoolModel.Class)theEObject;
				T result = caseClass(class_);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SchoolModelPackage.STUDENT: {
	 ...
	 * @generated
	 */
	public T caseClass(SchoolModel.Class object) {
		return null;
	}
