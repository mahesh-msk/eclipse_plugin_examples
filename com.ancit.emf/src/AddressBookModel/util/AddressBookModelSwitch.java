 ...
 * @generated
 */
public class AddressBookModelSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case AddressBookModelPackage.ADDRESS_BOOK: {
				AddressBook addressBook = (AddressBook)theEObject;
				T result = caseAddressBook(addressBook);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AddressBookModelPackage.GROUP: {
				Group group = (Group)theEObject;
				T result = caseGroup(group);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AddressBookModelPackage.CONTACT: {
